...
(() => {
  ...
  function setSegmentEventContext(event) {
    ...
    const checkout = window.Shopify?.Checkout ? {
      checkout: pick(window.Shopify?.Checkout, [
        "step",
        "customer",
        "token",
        "cartToken",
  ...
  // src/browser/index.ts
  async function main({
    writeKey = "gAzr37zAA55x2kbaJzzBAP6QgbcDriYw",
